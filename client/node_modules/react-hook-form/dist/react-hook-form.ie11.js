...
var appendId = function (value) { return (__assign(__assign({}, value), { id: generateId() })); };
...
var prependAt = (function (data, value) { return __spread([value || null], data); });

var insertAt = (function (data, index, value) { return __spread(data.slice(0, index), [
    value || null
], data.slice(index)); });

var useMemo = React.useMemo, useEffect$1 = React.useEffect, useRef$1 = React.useRef, useState$1 = React.useState;
function useFieldArray(_a) {
    ...
    }); }, [readFormStateRef]), isReadStateDirty = _d.isReadStateDirty, isReadStateTouched = _d.isReadStateTouched;
...
var ErrorMessage = function (_a) {
    var InnerComponent = _a.as, errors = _a.errors, name = _a.name, message = _a.message, children = _a.children;
    var methods = useFormContext();
